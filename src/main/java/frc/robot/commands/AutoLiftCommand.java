...
public class AutoLiftCommand extends Command {
  ...
  protected void execute() {
    ...
    if(Robot.liftSubsystem.Pot.getVoltage() > Robot.liftSubsystem.inchesToVolts(goalHeight)) Robot.liftSubsystem.moveLiftMech(0.5);
    if(Robot.liftSubsystem.Pot.getVoltage() < Robot.liftSubsystem.inchesToVolts(goalHeight)) Robot.liftSubsystem.moveLiftMech(-0.5);
  }
  ...
  protected boolean isFinished() {
    ...
    return Robot.liftSubsystem.voltsToInches(Robot.liftSubsystem.Pot.getVoltage()) > goalHeight-0.5 && Robot.liftSubsystem.voltsToInches(Robot.liftSubsystem.Pot.getVoltage()) < goalHeight+0.5;
    }
